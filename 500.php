...
$page['Title'] = "Internal Server Error - Fail Better Productions";
...
function generate_html_content($page) {
  ...
  write("    <h1>Error!</h1>");
//  write("    <p>We're sorry, but the page you requested (http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REDIRECT_URL'] . ") generated an error (" . $_SERVER['REDIRECT_ERROR_NOTES'] . ").</p>");
  write("    <p>We're sorry, but the page you requested (" . $_SERVER['REDIRECT_SCRIPT_URI'] . ") generated an error (" . $_SERVER['REDIRECT_ERROR_NOTES'] . ").</p>");
...
// - Use the search bar below to scan our site for the page you are looking for
  ...
  $body = "Server Error: " . $_SERVER['REDIRECT_SCRIPT_URI'] . "\n";
  $body .= "Referer: " . ($_SERVER['HTTP_REFERER'] ? $_SERVER['HTTP_REFERER'] : "<none>") . "\n";
  $body .= "User Agent: " . $_SERVER['HTTP_USER_AGENT'] . "\n";
  $body .= "Remote Address: " . $_SERVER['REMOTE_ADDR'] . "\n";
  $body .= "Redirect Error Notes: '" . $_SERVER['REDIRECT_ERROR_NOTES'] . "'\n";
  $body .= "Redirect Redirect Error Notes: '" . $_SERVER['REDIRECT_REDIRECT_ERROR_NOTES'] . "'\n";
  $body .= "\n\n\$_SERVER = " . trim(print_r($_SERVER, true)) . "\n";
  $body = wordwrap ($body, 70);
  @mail("failbetter-web@dave.thwaites.org.uk", "[failbetter.co.uk] Server Error at FailBetter.co.uk", $body, "From: Fail Better Website <info@failbetter.co.uk>\r\nReply-To: \"Change this address!..\" <failbetter-web@dave.thwaites.org.uk>\r\n");
